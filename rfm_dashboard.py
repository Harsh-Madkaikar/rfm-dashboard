...
# FILE UPLOAD OPTION
# ===============================
uploaded_file = st.file_uploader("Upload your transactional dataset (CSV) to override default", type=["csv"])
